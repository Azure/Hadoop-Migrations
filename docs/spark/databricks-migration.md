...
| ---------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| User  Management       | No  out of the box integration with Entra ID  Complex  user provisioning with Entra ID Domain Services | Out  of the box Entra ID Integration  Supports  Industry standard SCIM API for user  and group sync |
