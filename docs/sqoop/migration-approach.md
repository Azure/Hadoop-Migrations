...
Data Factory has a large number of connectors. See [Azure Data Factory connector overview](https://docs.microsoft.com/en-us/azure/data-factory/connector-overview) for details.
...
See “Azure Data Factory Managed Virtual Network”(https://docs.microsoft.com/en-us/azure/data-factory/managed-virtual-network-private-endpoint).

#### Private Link
You can use [Private Link](https://docs.microsoft.com/en-us/azure/private-link/) in Data Factory to create a Data Factory private endpoint in your customer's virtual network and enable a private connection to your Data Factory instance.

![Managed VNET and Privete Endpoints](../images/managed-vnet-architecture-diagram.png)

See “Azure Private Link for Azure Data Factory”(https://docs.microsoft.com/en-us/azure/data-factory/data-factory-private-link).
...
Refer to the [Copy activity performance and scalability guide](https://docs.microsoft.com/en-us/azure/data-factory/copy-activity-performance) and make adjustments to achieve your desired performance. 
...
As an example, see [Data Factory Properties](https://docs.microsoft.com/en-us/azure/data-factory/connector-mysql#copy-activity-properties) for getting the result set of a query using MySQL as the data source. 
...
See [Transform data in Azure Data Factory](https://docs.microsoft.com/en-us/azure/data-factory/transform-data) for more information. 
...
- Event-based trigger  
  ...
  - custom event trigger  
    Trigger to handle [Custom Topics](https://docs.microsoft.com/en-us/azure/event-grid/custom-topics) of [Event Grid](https://docs.microsoft.com/en-us/azure/event-grid/overview). 

For more information on triggers, see [Pipeline execution and triggers](https://docs.microsoft.com/en-us/azure/data-factory/concepts-pipeline-execution-triggers) in Azure Data Factory. 
